...
export default function Footer() {
  ...
  // Complete 16 Administrative & Site Routes matching STATIC_ROUTES in sitemap.ts
  const adminLinks = [
  ...
  return (
    <footer className="w-full bg-[#050506] border-t border-border/80 text-secondary py-12 md:py-16 mt-auto font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        
        {/* Main Footer Grid - Adjusted for Mobile Desktop Mode & standard Mobile */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 md:gap-8 pb-10 border-b border-border/80">
          ...
          <div className="md:col-span-4 flex flex-col space-y-4">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-lg md:text-xl font-extrabold tracking-wider text-primary">
                  CHRONOVERSE <span className="text-[#C8A7E8]">CAPITAL</span>
                </span>
                <div className="text-[10px] text-secondary font-mono tracking-widest mt-0.5">
                  www.chronoversecapital.com
                </div>
              </div>
            </Link>
            <p className="text-xs md:text-sm text-secondary leading-relaxed max-w-xs md:max-w-sm">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a
                ...
                className="text-secondary hover:text-purple-brand transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Reddit"
                className="text-secondary hover:text-[#ff4500] transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="text-secondary hover:text-[#e60023] transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Column 2: Exact 16 Administrative & Site Links (Takes 5 cols on desktop) */}
          <div className="md:col-span-5">
            <h3 className="text-xs font-semibold uppercase tracking-widest text-mauve mb-5">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-xs md:text-sm">
              {adminLinks.map((link) => (
                <Link
                  key={link.title}
                  href={link.href}
                  className="hover:text-[#C8A7E8] transition-colors text-secondary truncate"
                >
                  {link.title}
                </Link>
              ))}
          ...
          {/* Column 3: RESEARCH VAULT & RESOURCES (Takes 3 cols on desktop) */}
            ...
            <ul className="space-y-3.5 text-xs md:text-sm">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center text-secondary hover:text-[#C8A7E8] transition-colors group"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-[#C8A7E8] mr-2.5 group-hover:scale-125 transition-transform"></span>
                 Macro Research Monographs
                </a>
              </li>
              <li>
                <a
        ...
        {/* Disclaimer Notice */}
        <div className="py-6 border-b border-border/50 text-[11px] md:text-xs text-secondary leading-relaxed max-w-6xl">
          <span className="font-semibold text-secondary mr-1">Financial Disclaimer:</span>
        ...
        {/* Copyright */}
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-secondary gap-y-3">
