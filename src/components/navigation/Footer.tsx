...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#0d0a08] border-t border-zinc-800/80 text-zinc-300 py-12 md:py-16 mt-auto font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="md:col-span-4 flex flex-col space-y-4">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <div className="text-[10px] text-zinc-300 font-mono tracking-widest mt-0.5">
                  www.chronoversecapital.com
                </div>
              </div>
            </Link>
            <p className="text-xs md:text-sm text-zinc-300 leading-relaxed max-w-xs md:max-w-sm">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="text-zinc-300 hover:text-[#0a66c2] transition-colors duration-200"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Reddit"
                className="text-zinc-300 hover:text-[#ff4500] transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="text-zinc-300 hover:text-[#e60023] transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-xs md:text-sm">
              {adminLinks.map((link) => (
                <Link
                  key={link.title}
                  href={link.href}
                  className="hover:text-[#c87d55] transition-colors text-zinc-300 truncate"
                >
                  {link.title}
                </Link>
              ))}
        ...
        {/* Disclaimer Notice */}
        <div className="py-6 border-b border-zinc-800/50 text-[11px] md:text-xs text-zinc-300 leading-relaxed max-w-6xl">
          <span className="font-semibold text-zinc-300 mr-1">Financial Disclaimer:</span>
