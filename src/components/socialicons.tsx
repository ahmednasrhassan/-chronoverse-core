...
export const LinkedInIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <a
    ...
    aria-label="LinkedIn"
    className="text-muted hover:text-[#0a66c2] transition-colors duration-200 inline-flex items-center justify-center"
  >
...
export const TwitterIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <a
    ...
    className="text-muted hover:text-white transition-colors duration-200 inline-flex items-center justify-center"
  >
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export const RedditIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <a
    ...
    rel="noopener noreferrer"
    aria-label="Reddit"
    className="text-muted hover:text-[#ff4500] transition-colors duration-200 inline-flex items-center justify-center"
  >
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export const PinterestIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <a
    ...
    className="text-muted hover:text-[#e60023] transition-colors duration-200 inline-flex items-center justify-center"
  >
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
