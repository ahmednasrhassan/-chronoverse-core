    ...
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
      ...
      <section className="space-y-10 border-b border-[#27272a] pb-16">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 border-b border-[#27272a] pb-8">
          {/* Partner Logo Box */}
          <div className="w-28 h-28 bg-[#18181b] border border-[#27272a] rounded-2xl flex items-center justify-center font-black text-2xl text-[#c87d55] flex-shrink-0 shadow-inner">
            AfriKDP
          </div>
