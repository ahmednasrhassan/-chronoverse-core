...
export default function ArsenalProductsPage() {
  const arsenalItems = [
    ...
    },
    {
      ...
      badge: "NETWORK",
      badgeColor: "text-[#c87d55] bg-[#c87d55]/15 border-[#c87d55]/30",
      description: "The secure intelligence relay powering our global dispatch, priority market signals, and encrypted communication.",
      link: "https://intel.chronoversecapital.com/",
      btnText: "Initiate Access ➔",
      sponsored: false,
    },
  ];
