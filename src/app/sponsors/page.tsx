  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 space-y-20">
      ...
      <section className="text-center space-y-6 border-b border-[#27272a] pb-14">
        ...
        <div className="pt-4">
          <a
            ...
            className="inline-block bg-[#c87d55] hover:bg-[#d88d65] text-black font-bold px-8 py-3.5 rounded-lg transition-colors text-sm shadow-md"
          >
            Become a Sponsor →
          </a>
        </div>
      ...
      <section className="bg-[#0a0a0a] border border-[#27272a] rounded-2xl p-8 md:p-12 text-center space-y-6">
        <h2 className="text-2xl md:text-3xl font-bold text-[#f4f4f5]">
