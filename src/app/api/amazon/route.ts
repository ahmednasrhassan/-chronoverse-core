          ...
          Html: {
            Data: `
              <div style="font-family: monospace; background-color: #050506; color: #F3EBDD; padding: 24px; border: 1px solid #C8A7E8; border-radius: 8px;">
                <h2 style="color: #C8A7E8; margin-top: 0;">[Chronoverse AWS SES Relay Dispatch]</h2>
                <p><strong>Sender:</strong> ${email}</p>
                <p><strong>Payload:</strong></p>
                <blockquote style="background-color: #0D0D11; padding: 12px; border-left: 4px solid #C8A7E8; font-size: 14px; color: #CFC5B8;">
