...
export const eurgbpProfile = defineMarketAssetProfile({
  id: "eurgbp",
  symbol: "EURGBP=X",
  displayName: "EUR/GBP",
  assetClass: "forex",
  ...
  risk: {
    ...
    calibration: {
      ...
      macd: { highThreshold: 0.0015, lowSeverity: 0.2, highSeverity: 1 },
      emaMedium: {
        moderateThreshold: 1.5,
        highThreshold: 2.9,
        severity: { low: 0.2, moderate: 0.6, high: 1 },
